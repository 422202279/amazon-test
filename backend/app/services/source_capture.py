...
def preview_product_from_url(url: str, html: str | None = None) -> dict:
    ...
    payload = {
        ...
        "image_url": extract_meta_value(page_html, "property", "og:image"),
        "price_amount": None,
        "price_currency": None,
        "review_count": None,
        "rating": None,
    ...
    payload["title"] = payload["title"] or extract_title_tag(page_html) or "未识别标题"
